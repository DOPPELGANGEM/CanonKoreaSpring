...
--------------------------------------------------------
DROP TABLE "CANONKOREA"."MEMBER_TBL" cascade constraints;
--------------------------------------------------------
...
Insert into CANONKOREA.MEMBER_TBL (MEMBER_ID,MEMBER_PW,MEMBER_NAME,MEMBER_AGE,MEMBER_GENDER,MEMBER_EMAIL,MEMBER_PHONE,MEMBER_ADDRESS,MEMBER_HOBBY,MEMBER_DATE,UPDATE_DATE,MEMBER_YN) values ('khuser04','pass04','사용자',44,'M','khuser04','01044444444','서울시 중구','탁구',to_timestamp('23/08/13 20:16:23.227000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('23/08/13 20:16:23.227000000','RR/MM/DD HH24:MI:SSXFF'),'Y');
