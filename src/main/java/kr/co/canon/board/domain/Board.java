...
public class Board {
	...
	public String toString() {
		return "게시글 [글번호=" + boardNo + ", 글제목=" + boardTitle + ", 글내용=" + boardContent
				+ ", 작성자=" + boardWriter + ", 파일네임=" + boardFileName + ", 파일리네임=" + boardFileRename
				+ ", 파일경로=" + boardFilePath + ", 파일크기=" + boardFileLength + ", 조회수=" + boardCount
				+ ", 작성날짜=" + bCreateDate + ", 수정날짜=" + bUpdateDate + ", 사용여부=" + bStatus + "]";
	}
